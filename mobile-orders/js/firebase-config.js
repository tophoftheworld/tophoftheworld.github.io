...
import { getFirestore, connectFirestoreEmulator, enableNetwork } from 'https://www.gstatic.com/firebasejs/11.6.0/firebase-firestore.js';
import { getAuth } from 'https://www.gstatic.com/firebasejs/11.6.0/firebase-auth.js';

// Your Firebase config (same as expenses app)
...
export async function initializeFirebase() {
    try {
        ...
        console.log('Firebase offline mode:', error);
    }
}
