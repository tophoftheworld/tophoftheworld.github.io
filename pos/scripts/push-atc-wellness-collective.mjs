...
const EVENT_NAME = 'The Wellness Collective [ATC]';
const EVENT_KEY = 'popup-the-wellness-collective--atc-';
const menu = JSON.parse(
  fs.readFileSync(path.join(__dirname, '..', 'data', 'atc_wellness_collective_menu.json'), 'utf8')
);
...
const payload = {
  ...
  status: 'active',
  customMenu: menu,
  createdBy: 'atc-wellness-collective-setup',
