...
const EVENT_NAME = 'CEBU TWS';
const EVENT_KEY = 'popup-cebu-tws';
const ARCHIVE_KEY_PREFIXES = [
  'popup-sm-aura-2026',
  'popup-sm-aura',
  'popup-marikina-matcha-fest'
];
const menu = JSON.parse(
  fs.readFileSync(path.join(__dirname, '..', 'data', 'cebu_tws_menu.json'), 'utf8')
);
...
if (archivedNames.length) {
  ...
  console.log('No active SM Aura / Marikina events to archive.');
}
