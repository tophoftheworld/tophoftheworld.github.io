...
const EVENT_NAME = 'BGC - SEPT 5';
const EVENT_KEY = 'package-bgc-sept-5';
const menu = JSON.parse(
  fs.readFileSync(path.join(__dirname, '..', 'data', 'bgc_sept_5_menu.json'), 'utf8')
);
