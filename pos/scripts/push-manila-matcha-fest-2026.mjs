...
const EVENT_NAME = 'Manila Matcha Fest 2026';
const EVENT_KEY = 'popup-manila-matcha-fest-2026';
const menu = JSON.parse(
  fs.readFileSync(path.join(__dirname, '..', 'data', 'manila_matcha_fest_2026_menu.json'), 'utf8')
);
...
const payload = {
  ...
  status: 'active',
  customMenu: menu,
  createdBy: 'manila-matcha-fest-2026-setup',
